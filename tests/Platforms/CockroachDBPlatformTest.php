...
/** @extends AbstractPlatformTestCase<CockroachDBPlatform> */
class CockroachDBPlatformTest extends AbstractPlatformTestCase
{
    ...
    {
        return [
            [Types::SMALLINT, 'SERIAL2'],
            [Types::INTEGER, 'SERIAL4'],
            [Types::BIGINT, 'SERIAL8'],
        ];
    }
    ...
    /**
     * CockroachDB boolean strings provider
     *
     * @return mixed[][]
     */
