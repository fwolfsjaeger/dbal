...
class CockroachDBSchemaManagerTest extends SchemaManagerFunctionalTestCase
{
    use VerifyDeprecations;

    protected function supportsPlatform(AbstractPlatform $platform): bool
    {
        return $platform instanceof CockroachDBPlatform;
    }
    ...
    {
        assert($this->schemaManager instanceof CockroachDBSchemaManager);
    ...
    public function testAlterTableAutoIncrementAdd(callable $comparatorFactory): void
    {
        ...
        self::assertEquals([
            'DROP INDEX autoinc_table_add_pkey',
            'ALTER TABLE autoinc_table_add DROP rowid',
    ...
    public function testListSameTableNameColumnsWithDifferentSchema(): void
    {
        ...
        // CockroachDB automatically adds a rowid column
        // that serves as a primary key if no primary key
        ...
        $this->assertCount(3, $anotherSchemaTable->getColumns());
    ...
    public function testReturnQuotedAssets(): void
    {
        ...
        $sql = 'create table dbal91_something'
            . ' (id INT4 CONSTRAINT id_something PRIMARY KEY NOT NULL, "table" INT4)';
        ...
        self::assertEquals(
            [
                'CREATE TABLE dbal91_something (id INT4 NOT NULL, "table" INT4 DEFAULT NULL, PRIMARY KEY(id))',
    ...
    public function testListForeignKeys(): void
    {
        ...
        $fkOptionCount = count($fkOptions);
        $foreignKeys = [];
        $fkTable = $this->getTestTable('test_create_fk1');
        for ($i = 0; $i < $fkOptionCount; $i++) {
    ...
    /**
     * TODO might not be supported
     * CockroachDB stores BINARY columns as BLOB
     */
    ...
    /**
     * TODO might not be supported
     * CockroachDB stores VARBINARY columns as BLOB
     */
    ...
    public function testListTablesExcludesViews(): void
    {
        ...
        $sql = 'SELECT id, test, foreign_key_test from list_tables_excludes_views';
    ...
    public function testListNegativeColumnDefaultValue(): void
    {
        ...
        $table->addColumn('col_decimal', Types::DECIMAL, ['precision' => 2, 'scale' => 1, 'default' => -1.1]);
    ...
    public function testListTablesDoesNotIncludeViews(): void
    {
        ...
        $sql = 'SELECT id, test, foreign_key_test FROM test_table_for_view';
